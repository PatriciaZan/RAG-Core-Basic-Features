...
if __name__ == "__main__":
    from database_schema_enhanced import DATABASE_SCHEMA_ENHANCED, DATABASE_RELATIONSHIPS
    
    builder = SQLPromptBuilder(DATABASE_SCHEMA_ENHANCED, DATABASE_RELATIONSHIPS)
    
    # Exemplo 1: Pergunta sobre produtos
    question_1 = "Quais são os produtos mais vendidos em 2024?"
    print("=" * 80)
    print("PERGUNTA:", question_1)
    print("-" * 80)
    print(builder.explain_table_choice(question_1))
    print("\n" + "=" * 80)
    
    # Exemplo 2: Pergunta sobre características
    question_2 = "O produto Payment Gateway suporta qual OS?"
    print("PERGUNTA:", question_2)
    print("-" * 80)
    print(builder.explain_table_choice(question_2))
    print("\n" + "=" * 80)
    
    # Montar prompt completo
    print("\nPROMPT COMPLETO PARA CLAUDE:\n")
    full_prompt = builder.build_full_prompt(question_1)
